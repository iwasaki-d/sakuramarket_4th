class Admin::CommoditiesController < ApplicationController
  ...
  def create
    ...
    if @commodity.save
      redirect_to admin_commodities_url, notice: 'Commodity was successfully created.'
    else
      render :new
    end
  end
  ...
  private
    ...
    def commodity_params
      params.require(:commodity).permit(:name, :description, :position, :price, :enabled_view)
    end
end
